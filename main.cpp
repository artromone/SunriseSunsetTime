...
int main()
{
  for (int year = 1; year <= 9999; year++)
  {
    for (int month = 1; month <= 12; month++)
    {
      for (int day = 1; day <= DateTime::DaysInMonth(year, month); day++)
      {
        ...
        if (!jd_dmy(dt.ToJulian() + 0.5, year, month, day))
        {
  ...
  std::cout << d1.ToJulian() << std::endl;
  std::cout << d2.ToJulian() << std::endl;
  std::cout << d3.ToJulian() << std::endl;
  std::cout << d4.ToJulian() << std::endl;
  std::cout << d5.ToJulian() << std::endl;
  return 0;
}
